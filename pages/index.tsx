              ...
              {stage === 'complete' && (
                ...
                >
                  <div className="mx-auto max-w-2xl">
                    <p className="text-xs uppercase tracking-[0.4em] text-cyan-300/70">{activeQuiz.isFinalDay ? 'Global Money Week - Final Day' : 'Completed'}</p>
                    <h2 className="mt-4 text-3xl font-semibold text-white sm:text-5xl">
                      {activeQuiz.isFinalDay
                        ? 'That is a wrap on Global Money Week!'
                        : "Congratulations, you have finished today's quiz."}
                    </h2>
                    {activeQuiz.isFinalDay && (
                      <p className="mt-4 text-lg text-slate-300 sm:text-xl">
                        Congratulations to every homeroom that took part this week. You all showed up, competed hard, and learned something real. A special congratulations to our weekly winner - check the leaderboard to see who came out on top.
                      </p>
                    )}
                    ...
                    {!activeQuiz.isFinalDay && <p className="mt-8 text-base text-slate-300">Come back tomorrow for the next challenge.</p>}
